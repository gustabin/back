...
/**
 * The Class SimulacionClienteCompraManagerTest.
 */
@RunWith(MockitoJUnitRunner.class)
public class SimulacionClienteCompraManagerTest {
    ...
    @InjectMocks
    private SimulacionCompraVentaManager simulacionClienteCompraManager = new SimulacionCompraVentaManagerImpl();
    ...
    /**
     * Continuar compra dolares ok test.
     *
    ...
    @Ignore
    @Test
    public void continuarCompraDolaresOkTest() throws BusinessException {
        ...
        Mockito.when(simulacionClienteCompraBO.obtenerSimulacionClienteCompra(Matchers.any(ParametrosSimulacion.class)))
                .thenReturn(resSimulacion);
        Respuesta<SimulacionCompraVentaDolarView> res = simulacionClienteCompraManager
                .continuarCompraDolares(confirmarClienteCompra);
    ...
    /**
     * Continuar compra dolares exception test.
     */
    @Test
    public void continuarCompraDolaresExceptionTest() {
        Mockito.when(mensajeBO.obtenerMensajePorCodigo(Matchers.any(String.class))).thenReturn(mensaje);
        Respuesta<SimulacionCompraVentaDolarView> res = simulacionClienteCompraManager
                .continuarCompraDolares(new ContinuarCompraVentaEntity());
    ...
    public void crearRespuestaSimulacionErrorTest() throws BusinessException {
        ...
        confirmarClienteCompra.setNumeroCuentaOrigen("12-12");
        confirmarClienteCompra.setNumeroCuentaDestino("13-13");
        confirmarClienteCompra.setIsDolar(Boolean.TRUE);
