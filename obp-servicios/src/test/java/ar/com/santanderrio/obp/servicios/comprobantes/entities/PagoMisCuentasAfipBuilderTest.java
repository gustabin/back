...
public class PagoMisCuentasAfipBuilderTest {
    @Test
    public void crearAltaPMCAfipDomestico() {
        ...
        PagoMisCuentasAFIPBuilder builder = new PagoMisCuentasAFIPBuilder(cliente).setPagoInEntity(pagoInEntity)
                .setPagoResponse(pagoResponse).setIdentificacion2("1324516341").setDatosAdicionales1("")
                .setDatosAdicionales2("").isDomestico(true);

        AltaComprobanteRequest alta = builder.buildComprobanteRequest();
        Assert.assertEquals("14", alta.getSubTipoComprobante());
    }
    
    @Test
    public void crearAltaPMCAfipNoDomestico() {
        Cliente cliente = new Cliente();
        cliente.setNup("12315123");
        cliente.setDni("37866881");
        cliente.setTipoDocumento("N");
        ...
        PagoMisCuentasAFIPBuilder builder = new PagoMisCuentasAFIPBuilder(cliente).setPagoInEntity(pagoInEntity)
                .setPagoResponse(pagoResponse).setIdentificacion2("1324516341").setDatosAdicionales1("")
                .setDatosAdicionales2("").isDomestico(false);
