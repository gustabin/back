...
import ar.com.santanderrio.obp.servicios.database.dao.EstadisticaDAOIT.EstadisticaDAOITConfiguration;
...
@ContextConfiguration(loader = AnnotationConfigContextLoader.class, classes = { EstadisticaDAOITConfiguration.class,
...
@Ignore
public class EstadisticaDAOIT extends HbankBaseDAOIT {
    ...
    @ComponentScan(basePackages = { "ar.com.santanderrio.obp.servicios.comun.estadistica.dao",
    ...
    public static class EstadisticaDAOITConfiguration {
     ...
     */
    @Test
    public void addEstadistica() throws DAOException {
        Estadistica estadistica = new Estadistica();
        estadistica.setCodigoTransaccion("0");
        estadistica.setCodigoError("2");
        estadistica.setClienteDNI("13238861");
        estadistica.setFechaNacimiento("19000101");
        estadisticaDAO.add(estadistica);
    }
}
