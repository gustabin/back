...
@ContextConfiguration(loader = AnnotationConfigContextLoader.class, classes = { ObeSEIIT.ObeSEIITestConfiguration.class })
public class ObeSEIIT extends AbstractSEITest {
    ...
    @Configuration
    public static class ObeSEIITestConfiguration {
         ...
         */
        @Bean(name = "obeSEI")
        public ObeSEI obeSEI() {
            return new ObeSEIImpl();
        }
         ...
         */
        @Bean
        ObeManager obeManager() {
            return Mockito.mock(ObeManager.class);
        }
    }
    ...
    public void obtenerTokenEncriptado() {
        ...
        Mockito.when(obeManager.obtenerTokenEncriptado(Matchers.any(MessageContext.class))).thenReturn(respuesta);

        WebClient client = getWebClient();
        client.type(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON);
        client.path("/obe/obtenerTokenEncriptado");
    ...
    protected Object getServiceBeanToTest() {
        return applicationContext.getBean("obeSEI");
    }
