...
public class AdvantageBaseDAOIT {
    /** The Constant LOGGER. */
    private static final Logger LOGGER = LoggerFactory.getLogger(AdvantageBaseDAOIT.class);
...
//            ds.setURL("jdbc:oracle:thin:@localhost:1521:xe");
            ...
            testConDS.setURL("jdbc:oracle:thin:@desadb2.ar.bsch:1570:rio52d2");
            try {
