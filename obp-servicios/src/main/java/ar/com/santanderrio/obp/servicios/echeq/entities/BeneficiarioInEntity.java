...
/**
 * The Class BeneficiarioInEntity.
 */
public class BeneficiarioInEntity {
	 ...
	 *
	 * @param benTipoDocumento
	 *     the new ben tipo documento
	 */
	 ...
	 *
	 * @param benRazonSocial
	 *     the new ben razon social
	 */
