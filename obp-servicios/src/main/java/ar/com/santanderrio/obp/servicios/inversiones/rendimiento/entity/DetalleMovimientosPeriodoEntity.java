...
/**
 * The Class DetalleMovimientosPeriodoEntity.
 */
public class DetalleMovimientosPeriodoEntity {
	...
	/** The datos. */
	@JsonProperty("Datos")	
	private DatosRespuestaDetalleMovimientosPeriodo datos;
	 ...
	 * @return the datos
	 */
	public DatosRespuestaDetalleMovimientosPeriodo getDatos() {
		return datos;
	}
	 ...
	 *            the new datos
	 */
	public void setDatos(DatosRespuestaDetalleMovimientosPeriodo datos) {
		this.datos = datos;
	}
