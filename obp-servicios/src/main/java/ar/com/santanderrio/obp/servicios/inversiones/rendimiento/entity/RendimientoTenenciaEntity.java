...
/**
 * The Class RendimientoTenenciaEntity.
 *
 * @author b039920
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class RendimientoTenenciaEntity {
	...
	/** The datos. */
	@JsonProperty("Datos")
	private DatosRespuestaRendimientoTenencia datos;

	/**
	 * Instantiates a new detalle tenencia valuada entity.
	 */
	public RendimientoTenenciaEntity() {
		datos = new DatosRespuestaRendimientoTenencia();
		codigo = -1;
	}
	 ...
	 * @return the datos
	 */
	public DatosRespuestaRendimientoTenencia getDatos() {
		return datos;
	}
	 ...
	 *            the new datos
	 */
	public void setDatos(DatosRespuestaRendimientoTenencia datos) {
		this.datos = datos;
	}
