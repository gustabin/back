...
public class FondosEntity {
	...
	public String toString() {
		return "FondosEntity [anio=" + anio + ", codFondo=" + codFondo + ", descripcion=" + descripcion + ", cuenta="
				+ cuenta + ", divisa=" + divisa + ", saldoCuotas=" + saldoCuotas + ", valorCuota=" + valorCuota
				+ ", cotiAfip=" + cotiAfip + ", importe=" + importe + ", sumRenta=" + sumRenta + "]";
	}
