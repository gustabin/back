...
/**
 * The Class AfipCategoriaCincoMedioPagoBOImpl.
 */
@Component
public class AfipCategoriaCincoMedioPagoBOImpl implements TipoMedioPagoBO {
    ...
    public boolean esTipoNuevoPago(final MedioPago medioPago) {
        return medioPago.getTipoPago() != null && medioPago.getTipoPago().equals(2)
                ...
                && "5".equals(medioPago.getDatosAdicionales());
    }
    ...
    public AltaComprobanteRequestBuilder generarAltaScompRequest(Cliente cliente, PagoPMC res, PagoInEntity pago,
        ...
        if (pagoMisCuentasDTO != null) {
            return builder.setDatosAdicionales1(pagoMisCuentasDTO.getNumeroDeCuota());
        }
        return builder.setDatosAdicionales1(pmView.getNumeroDeCuota());
    }
    ...
    public TipoNuevoPagoEnum getTipoNuevoPagoEnum() {
        return TipoNuevoPagoEnum.AFIP_CAT5;
    }
	 ...
	 */
    public void setDomesticoMedioPagoBO(DomesticoMedioPagoBOImpl domestico) {
       this.domesticoMedioPagoBO = domestico;
    }
