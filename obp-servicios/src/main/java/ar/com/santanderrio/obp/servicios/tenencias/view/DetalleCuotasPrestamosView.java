...
/**
 * The Class DetalleCuotasPrestamosView.
 */
public class DetalleCuotasPrestamosView extends Entity {
	...
	/** The sdo ant sin ajustar. */
	private String sdoAntSinAjustar;
	...
	/**
	 * Gets the sdo ant sin ajustar.
	 *
	 * @return the sdoAntSinAjustar
	 */
	public String getSdoAntSinAjustar() {
		return sdoAntSinAjustar;
	}

	/**
	 * Sets the sdo ant sin ajustar.
	 *
	 * @param sdoAntSinAjustar
	 *            the sdoAntSinAjustar to set
	 */
	public void setSdoAntSinAjustar(String sdoAntSinAjustar) {
		this.sdoAntSinAjustar = sdoAntSinAjustar;
	}
	 ...
	 *            the intMora to set
	 */
	public void setIntMora(String intMora) {
	...
	public String toString() {
		return "DetalleCuotasPrestamosView [anio=" + anio + ", cuenta=" + cuenta + ", pecodpro=" + pecodpro
				+ ", pecodsub=" + pecodsub + ", pecodofi=" + pecodofi + ", nroRecibo=" + nroRecibo + ", fechaVto="
				+ fechaVto + ", estado=" + estado + ", sdoAntSinAjustar=" + sdoAntSinAjustar + ", importeCuota="
				+ importeCuota + ", capital=" + capital + ", intereses=" + intereses + ", gastos=" + gastos
				+ ", comisiones=" + comisiones + ", seguros=" + seguros + ", impuestos=" + impuestos + ", intComp="
				+ intComp + ", intMora=" + intMora + ", tna=" + tna + "]";
	}
