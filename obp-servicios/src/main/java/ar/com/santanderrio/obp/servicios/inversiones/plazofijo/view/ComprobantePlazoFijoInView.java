...
/**
 * The Class ComprobantePlazoFijoInView.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class ComprobantePlazoFijoInView {
	 ...
	 *
	 * @param codigoPlazo the new codigo plazo
	 */
	 ...
	 *
	 * @param minimoDiasPrecancelar the new minimo dias precancelar
	 */
	 ...
	 *
	 * @param porcentajePenalizacion the new porcentaje penalizacion
	 */
