...
/**
 * The Class AfipCategoriaUnoMedioPagoBOImpl.
 */
@Component
public class AfipCategoriaUnoMedioPagoBOImpl implements TipoMedioPagoBO{
    ...
    public boolean esTipoNuevoPago(final MedioPago medioPago) {
        return medioPago.getTipoPago() != null && medioPago.getTipoPago().equals(2)
                && "1".equals(medioPago.getDatosAdicionales())
    ...
    public TipoNuevoPagoEnum getTipoNuevoPagoEnum() {
        return TipoNuevoPagoEnum.AFIP_CAT1;
    }
