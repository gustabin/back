...
/**
 * The Class DetalleRentabilidadEntity.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class DetalleRentabilidadEntity {
	...
	/** The datos. */
	@JsonProperty("Datos")
	private DatosRespuestaDetalleRentabilidad datos;
	 ...
	 * @return the datos
	 */
	public DatosRespuestaDetalleRentabilidad getDatos() {
		return datos;
	}
	 ...
	 *            the new datos
	 */
	public void setDatos(DatosRespuestaDetalleRentabilidad datos) {
		this.datos = datos;
	}
