...
/**
 * The Class CelularRecargaMedioPagoBOImpl.
 */
@Component
public class CelularRecargaMedioPagoBOImpl implements TipoMedioPagoBO {
    ...
    public boolean esTipoNuevoPago(final MedioPago medioPago) {
        return TipoNuevoPagoEnum.CELULAR_RECARGA.getDescripcion().equals(medioPago.getRubroFantasia());
    }
    ...
    public PagoInEntity generarPagoInEntity(final PagoMisCuentasDTO pagoMisCuentasDTO) {
        return (new PagoInEntityBuilder()).recargaCelularSube(pagoMisCuentasDTO);
    }
    ...
    public TipoNuevoPagoEnum getTipoNuevoPagoEnum() {
        return TipoNuevoPagoEnum.CELULAR_RECARGA;
    }
