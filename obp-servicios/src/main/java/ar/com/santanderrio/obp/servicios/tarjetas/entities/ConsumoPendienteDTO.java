...
/**
 * The Class ConsumoPendienteDTO.
 */
public class ConsumoPendienteDTO {
	...
	/** The lineas. */
	private List<LineaDetalleConsumoPendienteDTO> lineas = new ArrayList<LineaDetalleConsumoPendienteDTO>();
	 ...
	 * @return the lineas
	 */
	public List<LineaDetalleConsumoPendienteDTO> getLineas() {
		return lineas;
	}
	 ...
	 *            the new lineas
	 */
	public void setLineas(List<LineaDetalleConsumoPendienteDTO> lineas) {
		this.lineas = lineas;
	}
	...
	public boolean equals(Object obj) {
		...
		ConsumoPendienteDTO other = (ConsumoPendienteDTO) obj;
