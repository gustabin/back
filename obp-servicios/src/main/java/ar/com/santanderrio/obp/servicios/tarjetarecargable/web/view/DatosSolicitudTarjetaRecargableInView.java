...
/**
 * The Class DatosSolicitudTarjetaRecargableInView.
 */
public class DatosSolicitudTarjetaRecargableInView {

	/** The apellido adic. */
	private String apellidoAdic;

	/** The nombre adci. */
	private String nombreAdci;
	...
	/**
	 * Gets the nombre adci.
	 *
	 * @return the nombre adci
	 */
	public String getNombreAdci() {
		return nombreAdci;
	}

	/**
	 * Sets the nombre adci.
	 *
	 * @param nombreAdci
	 *            the new nombre adci
	 */
	public void setNombreAdci(String nombreAdci) {
		this.nombreAdci = nombreAdci;
	}
