...
/**
 * The Class ConsultaInformacionMercadoResponse.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class ConsultaInformacionMercadoResponse {
	...
	/** The datos. */
	@JsonProperty("Datos")
	private DatosConsultaInformacionMercadoResponse datos;
	 ...
	 * @return the datos
	 */
	public DatosConsultaInformacionMercadoResponse getDatos() {
		return datos;
	}
	 ...
	 *            the datos to set
	 */
	public void setDatos(DatosConsultaInformacionMercadoResponse datos) {
		this.datos = datos;
	}
