 ...
 */
@Component
public class SubeRecargaMedioPagoBOImpl implements TipoMedioPagoBO {
    ...
    public boolean esTipoNuevoPago(final MedioPago medioPago) {
        return TipoNuevoPagoEnum.SUBE_RECARGA.getDescripcion().equals(medioPago.getFiid());
    }
    ...
    public TipoNuevoPagoEnum getTipoNuevoPagoEnum() {
        return TipoNuevoPagoEnum.SUBE_RECARGA;
    }
