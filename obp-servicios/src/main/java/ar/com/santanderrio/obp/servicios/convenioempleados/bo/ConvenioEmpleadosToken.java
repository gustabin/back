package ar.com.santanderrio.obp.servicios.convenioempleados.bo;
...
@Component
public class ConvenioEmpleadosToken extends AbstractTokenEntesExternos {

    private static final String CONSUMER = "OBP";
    
    private static final String PROCESS_DEFINITION_CODE = "2010";
    
    private static final String JKS = "DOCUSD"; //bcorio
    
    private static final String INDIVIDUO = "I";

    @Value("${LISTDOCUMENTS.URL}") //Url microfrontend ListDocuments
    private String url;
