...
/**
 * The Class FiltroCarteraEntity.
 */
public class FiltroCarteraEntity {
	...
	/** The datos. */
	@JsonProperty("Datos")
	private DatosRespuestaFiltroCartera datos;
	 ...
	 * @return the datos
	 */
	public DatosRespuestaFiltroCartera getDatos() {
		return datos;
	}
	 ...
	 *            the new datos
	 */
	public void setDatos(DatosRespuestaFiltroCartera datos) {
		this.datos = datos;
	}
