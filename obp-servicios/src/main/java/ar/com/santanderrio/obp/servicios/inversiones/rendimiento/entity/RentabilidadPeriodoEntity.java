...
/**
 * The Class RentabilidadPeriodoEntity.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class RentabilidadPeriodoEntity {
	...
	/** The datos. */
	@JsonProperty("Datos")
	private DatosRespuestaRentabilidadPeriodoEntity datos;
	 ...
	 * @return the datos
	 */
	public DatosRespuestaRentabilidadPeriodoEntity getDatos() {
		return datos;
	}
	 ...
	 *            the new datos
	 */
	public void setDatos(DatosRespuestaRentabilidadPeriodoEntity datos) {
		this.datos = datos;
	}
