...
public class LimitesTarjeta {

	/** The limites. */
	@XmlElement(name = "limite")
	private List<LimiteTarjetaEntity> limites;
	 ...
	 * @return the limites
	 */
	public List<LimiteTarjetaEntity> getLimites() {
		return limites;
	}
	 ...
	 *            the limites to set
	 */
	public void setLimites(List<LimiteTarjetaEntity> limites) {
	...
	public boolean equals(Object obj) {
		...
		LimitesTarjeta other = (LimitesTarjeta) obj;
