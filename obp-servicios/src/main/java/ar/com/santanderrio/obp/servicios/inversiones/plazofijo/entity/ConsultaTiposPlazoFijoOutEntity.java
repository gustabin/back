 ...
 */
@Record
public class ConsultaTiposPlazoFijoOutEntity {
	...
	private List<ConsultaTiposPlazoFijoEntity> tipoPF = new ArrayList<ConsultaTiposPlazoFijoEntity>();
	 ...
	 *            the new tipo PF
	 */
	public void setTipoPF(List<ConsultaTiposPlazoFijoEntity> tipoPF) {
		this.tipoPF = tipoPF;
	}
	 ...
	 * @return the tipo PF
	 */
	public List<ConsultaTiposPlazoFijoEntity> getTipoPF() {
		return tipoPF;
	}
	...
	public boolean equals(Object obj) {
		...
		ConsultaTiposPlazoFijoOutEntity other = (ConsultaTiposPlazoFijoOutEntity) obj;
