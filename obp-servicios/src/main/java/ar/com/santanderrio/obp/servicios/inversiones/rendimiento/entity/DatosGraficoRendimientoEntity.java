...
/**
 * The Class DatosGraficoRendimientoEntity.
 */
public class DatosGraficoRendimientoEntity {
	...
	private List<GraficoRendimientoRespuesta> resultado;
	 ...
	 */
	public List<GraficoRendimientoRespuesta> getResultado() {
		return resultado;
	}
	 ...
	 *            the new resultado
	 */
	public void setResultado(List<GraficoRendimientoRespuesta> resultado) {
