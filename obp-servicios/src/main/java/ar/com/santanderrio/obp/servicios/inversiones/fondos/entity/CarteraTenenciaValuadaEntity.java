...
public class CarteraTenenciaValuadaEntity {
	...
	/** The datos. */
	@JsonProperty("Datos")
	private DatosRespuestaCartera datos;

	/**
	 * Instantiates a new detalle tenencia valuada entity.
	 */
	public CarteraTenenciaValuadaEntity() {
		datos = new DatosRespuestaCartera();
		codigo = -1;
	}
	 ...
	 * @return the datos
	 */
	public DatosRespuestaCartera getDatos() {
		return datos;
	}
	 ...
	 *            the new datos
	 */
	public void setDatos(DatosRespuestaCartera datos) {
		this.datos = datos;
	}
