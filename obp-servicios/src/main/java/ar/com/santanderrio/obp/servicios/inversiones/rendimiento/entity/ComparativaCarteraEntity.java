...
/**
 * The Class ComparativaCarteraEntity.
 */
public class ComparativaCarteraEntity {
	...
	/** The datos. */
	@JsonProperty("Datos")
	private DatosComparativaCartera datos;
	 ...
	 * @return the datos
	 */
	public DatosComparativaCartera getDatos() {
		return datos;
	}
	 ...
	 *            the new datos
	 */
	public void setDatos(DatosComparativaCartera datos) {
		this.datos = datos;
	}
