...
/**
 * The Class DatosDetalleRentabilidad.
 */
public class DatosDetalleRentabilidad extends EntityBase {
	...
	/**
	 * Gets the sub clasificacion.
	 *
	 * @return the sub clasificacion
	 */
	...
	/**
	 * Sets the sub clasificacion.
	 *
	 * @param subClasificacion
	 *            the new sub clasificacion
	 */
