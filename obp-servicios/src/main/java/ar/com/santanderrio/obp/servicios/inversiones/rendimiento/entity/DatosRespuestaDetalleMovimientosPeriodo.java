...
/**
 * The Class DatosRespuestaDetalleMovimientosPeriodo.
 */
public class DatosRespuestaDetalleMovimientosPeriodo {
	...
	private List<DetalleInstrumentoPeriodo> resultado;
	 ...
	 */
	public List<DetalleInstrumentoPeriodo> getResultado() {
		return resultado;
	}
	 ...
	 *            the new resultado
	 */
	public void setResultado(List<DetalleInstrumentoPeriodo> resultado) {
