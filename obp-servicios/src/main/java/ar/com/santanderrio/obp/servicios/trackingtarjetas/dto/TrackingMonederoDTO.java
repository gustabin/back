 ...
 */
public class TrackingMonederoDTO {
	 ...
	 *
	 * @param numeroTarjetaTag the new numero tarjeta tag
	 */
	 ...
	 *
	 * @param nombreEmbozado the new nombre embozado
	 */
	 ...
	 *
	 * @param estadoTarjetaTag the new estado tarjeta tag
	 */
