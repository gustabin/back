...
/**
 * The Class DetalleSubclasificacionEntity.
 */
public class DetalleSubclasificacionEntity {
	...
	/** The datos. */
	@JsonProperty("Datos")
	private DatosRespuestaDetalleSubclasificacion datos;
	 ...
	 * @return the datos
	 */
	public DatosRespuestaDetalleSubclasificacion getDatos() {
		return datos;
	}
	 ...
	 *            the new datos
	 */
	public void setDatos(DatosRespuestaDetalleSubclasificacion datos) {
		this.datos = datos;
	}
