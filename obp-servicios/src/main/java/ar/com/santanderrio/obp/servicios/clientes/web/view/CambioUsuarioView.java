...
@XmlRootElement(name = "cambioUsuarioView", namespace = "bean")
@XmlAccessorType(XmlAccessType.FIELD)
@JsonIgnoreProperties(ignoreUnknown = true)
public class CambioUsuarioView extends RsaDTOParaDesafio {
    ...
    /**
     * Instantiates a new cambio usuario view.
     */
    @JsonIgnore
    public CambioUsuarioView() {
        super(OperacionesRSAEnum.CAMBIOUSUARIO);
    }
