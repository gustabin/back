...
/**
 * The Class DatosRespuestaRendimientoTenencia.
 */
public class DatosRespuestaRendimientoTenencia {
	...
	private List<ResultadoRendimientoTenenciaEntity> resultado;
	 ...
	 */
	public List<ResultadoRendimientoTenenciaEntity> getResultado() {
		return resultado;
	}
	 ...
	 *            the new resultado
	 */
	public void setResultado(List<ResultadoRendimientoTenenciaEntity> resultado) {
