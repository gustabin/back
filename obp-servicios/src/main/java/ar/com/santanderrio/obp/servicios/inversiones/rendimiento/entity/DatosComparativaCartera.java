...
/**
 * The Class DatosComparativaCartera.
 */
public class DatosComparativaCartera {
	...
	private List<ResultadoComparativaCartera> resultado;
	 ...
	 */
	public List<ResultadoComparativaCartera> getResultado() {
		return resultado;
	}
	 ...
	 *            the new resultado
	 */
	public void setResultado(List<ResultadoComparativaCartera> resultado) {
