...
/**
 * The Class MonotributoMedioPagoBOImpl.
 */
@Component
public class MonotributoMedioPagoBOImpl implements TipoMedioPagoBO {
    ...
    public boolean esTipoNuevoPago(final MedioPago medioPago) {
        return medioPago.getTipoPago() != null && 2 == medioPago.getTipoPago()
                && ! domesticoMedioPagoBO.esTipoNuevoPago(medioPago)
                && "3".equals(medioPago.getDatosAdicionales());
    }
    ...
    public AltaComprobanteRequestBuilder generarAltaScompRequest(Cliente cliente, PagoPMC res, PagoInEntity pago,
        ...
        if (pagoMisCuentasDTO != null) {
            return builder.setDatosAdicionales1(pagoMisCuentasDTO.getPeriodoPago().substring(0, 2))
                    .setDatosAdicionales2(pagoMisCuentasDTO.getPeriodoPago().substring(2));
        }
        return builder.setDatosAdicionales1(pmView.getPeriodoPago().substring(0, 2))
    ...
    public TipoNuevoPagoEnum getTipoNuevoPagoEnum() {
        return TipoNuevoPagoEnum.MONOTRIBUTO;
    }
