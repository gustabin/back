...
import ar.com.santanderrio.obp.servicios.documentaciondolares.bo.DocumentacionDolaresToken;
...
@Component
public class DocumentacionDolaresTokenManagerImpl implements TokenManager{

    @Autowired
    private SesionCliente sesionCliente;

    @Autowired
    private DocumentacionDolaresToken documentacionDolaresTokenBO;
	
	@Override
	public Respuesta<TokenView> obtenerTokenEncriptado() {
        Respuesta<TokenDTO> respuesta = documentacionDolaresTokenBO.obtenerHash(sesionCliente);
