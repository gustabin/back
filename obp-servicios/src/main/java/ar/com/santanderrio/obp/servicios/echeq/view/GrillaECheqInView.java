...
/**
 * The Class GrillaECheqInView.
 */
public class GrillaECheqInView {
	...
	/** The fecha rango emision. */
	private String fechaRangoEmision;
	...
	/**
	 * Gets the fecha rango emision.
	 *
	 * @return the fecha rango emision
	 */
	public String getFechaRangoEmision() {
		return fechaRangoEmision;
	}

	/**
	 * Sets the fecha rango emision.
	 *
	 * @param fechaRangoEmision the new fecha rango emision
	 */
	public void setFechaRangoEmision(String fechaRangoEmision) {
		this.fechaRangoEmision = fechaRangoEmision;
	}
