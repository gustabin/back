...
public class ResultadoMerlinEntity {
	...
	@Field
	private Long cantidadDeDudas;

	/** The dudas. */
	@Segment(occursRef = "cantidadDeDudas")
	private List<DudaEntity> dudas;
	 ...
	 *
	 * @return the cantidadDeDudas
	 */
	public Long getCantidadDeDudas() {
	 ...
	 *            the cantidadDeDudas to set
	 */
	public void setCantidadDeDudas(Long cantidadDeDudas) {
