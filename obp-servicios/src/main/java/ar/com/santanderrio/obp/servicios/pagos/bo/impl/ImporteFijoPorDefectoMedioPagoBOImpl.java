...
/**
 * The Class ImporteFijoPorDefectoMedioPagoBOImpl.
 */
@Component
public class ImporteFijoPorDefectoMedioPagoBOImpl implements TipoMedioPagoBO {
    ...
    public boolean esTipoNuevoPago(final MedioPago medioPago) {
        return medioPago.getTipoPago() != null && medioPago.getTipoPago().equals(3)
                && "0".equals(medioPago.getTipoImporte()) && !"F".equals(medioPago.getTipoEmpresa());
    }
    ...
    public TipoNuevoPagoEnum getTipoNuevoPagoEnum() {
        return TipoNuevoPagoEnum.CUSTOM_IMPORTE_FIJO;
    }
