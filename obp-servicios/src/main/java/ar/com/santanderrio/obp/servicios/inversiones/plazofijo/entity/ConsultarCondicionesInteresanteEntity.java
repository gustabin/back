...
/**
 * The Class ConsultarCondicionesInteresanteEntity.
 *
 * @author juan.pablo.picate
 */
public class ConsultarCondicionesInteresanteEntity {
	...
	public String toString() {
		return new ToStringBuilder(this).append("fechaProximaLiquidacion", fechaProximaLiquidacion)
				.append("capital", capital).append("interes", interes).append("impuestos", impuestos)
