...
public class GetEstadoClienteV3DTOOut {
    ...
    private List<MyaDestinoV3> listMyaDestino;
	...
	public List<MyaDestinoV3> getListMyaDestino() {
		return listMyaDestino;
	}
	
	public void setListMyaDestino(List<MyaDestinoV3> listMyaDestino) {
