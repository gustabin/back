...
/**
 * The Class ConsultaDeTenenciaResponse.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class ConsultaDeTenenciaResponse {
	...
	/** The datos. */
	@JsonProperty("Datos")
	private DatosConsultaDeTenenciaResponse datos;
	 ...
	 * @return the datos
	 */
	public DatosConsultaDeTenenciaResponse getDatos() {
		return datos;
	}
	 ...
	 *            the datos to set
	 */
	public void setDatos(DatosConsultaDeTenenciaResponse datos) {
		this.datos = datos;
	}
