...
/**
 * The Class DetalleTenenciaValuadaTitulosEntity.
 *
 * @author juan.pablo.picate
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class DetalleTenenciaValuadaTitulosEntity {
	...
	/** The datos. */
	@JsonProperty("Datos")
	private DatosRespuestaTitulos datos;
	 ...
	 * @return the datos
	 */
	public DatosRespuestaTitulos getDatos() {
		return datos;
	}
	 ...
	 *            the new datos
	 */
	public void setDatos(DatosRespuestaTitulos datos) {
		this.datos = datos;
	}
}
