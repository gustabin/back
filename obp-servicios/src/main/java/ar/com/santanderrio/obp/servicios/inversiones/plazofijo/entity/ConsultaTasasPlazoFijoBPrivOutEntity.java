...
@Record
public class ConsultaTasasPlazoFijoBPrivOutEntity {
	...
	private List<TasasPlazoFijoBPrivEntity> listaTasas = new ArrayList<TasasPlazoFijoBPrivEntity>();
	 ...
	 * @return the tipoPF
	 */
	public List<TasasPlazoFijoBPrivEntity> getListaTasas() {
		return listaTasas;
	}
	 ...
	 *            the tipoPF to set
	 */
	public void setListaTasas(List<TasasPlazoFijoBPrivEntity> listaTasas) {
