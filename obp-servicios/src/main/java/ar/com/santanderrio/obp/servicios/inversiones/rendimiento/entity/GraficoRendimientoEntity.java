...
/**
 * The Class GraficoRendimientoEntity.
 */
public class GraficoRendimientoEntity {
	...
	/** The datos. */
	@JsonProperty("Datos")
	private DatosGraficoRendimientoEntity datos;
	 ...
	 * @return the datos
	 */
	public DatosGraficoRendimientoEntity getDatos() {
		return datos;
	}
	 ...
	 *            the new datos
	 */
	public void setDatos(DatosGraficoRendimientoEntity datos) {
		this.datos = datos;
	}
