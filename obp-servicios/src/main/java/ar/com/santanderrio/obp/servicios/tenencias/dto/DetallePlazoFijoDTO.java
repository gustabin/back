...
/**
 * The Class DetallePlazoFijoDTO.
 */
public class DetallePlazoFijoDTO {
	 ...
	 *
	 * @param cuentaDebitoTipo
	 *            the cuentaDebitoTipo to set
	 */
	 ...
	 *
	 * @param cuentaDebitoSuc
	 *            the cuentaDebitoSuc to set
	 */
	 ...
	 *
	 * @param cuentaDebitoNro
	 *            the cuentaDebitoNro to set
	 */
	 ...
	 *
	 * @param cuentaCreditoTipo
	 *            the cuentaCreditoTipo to set
	 */
	 ...
	 *
	 * @param cuentaCreditoSuc
	 *            the cuentaCreditoSuc to set
	 */
	 ...
	 *
	 * @param cuentaCreditoNro
	 *            the cuentaCreditoNro to set
	 */
	...
	public String toString() {
		return "DetallePlazoFijoDTO [anio=" + anio + ", pecodpro=" + pecodpro + ", pecodsub=" + pecodsub + ", pecodofi="
				+ pecodofi + ", penumcon=" + penumcon + ", certificado=" + certificado + ", divisa=" + divisa
				+ ", saldo=" + saldo + ", intCobrado=" + intCobrado + ", ajuCobrado=" + ajuCobrado + ", intDevengado="
				+ intDevengado + ", ajuDevengado=" + ajuDevengado + ", retGanancias=" + retGanancias + ", estado="
				+ estado + ", cuentaDebitoTipo=" + cuentaDebitoTipo + ", cuentaDebitoSuc=" + cuentaDebitoSuc
				+ ", cuentaDebitoNro=" + cuentaDebitoNro + ", cuentaCreditoTipo=" + cuentaCreditoTipo
				+ ", cuentaCreditoSuc=" + cuentaCreditoSuc + ", cuentaCreditoNro=" + cuentaCreditoNro + ", plazo="
				+ plazo + ", fechaVencimiento=" + fechaVencimiento + ", fechaConstitucion=" + fechaConstitucion + ", tipo=" + tipo + "]";
	}
