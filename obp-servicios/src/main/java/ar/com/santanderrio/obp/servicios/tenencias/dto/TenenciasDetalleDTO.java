 ...
 *
 */
public class TenenciasDetalleDTO {
	...
	private List<DatosParticipantesDTO> participantesDTO;
	
	
	/**
	 * @return the participantesDTO
	 */
	public List<DatosParticipantesDTO> getParticipantesDTO() {
	 ...
	 */
	public void setParticipantesDTO(List<DatosParticipantesDTO> participantesDTO) {
	...
	public boolean equals(Object obj) {
		...
		TenenciasDetalleDTO other = (TenenciasDetalleDTO) obj;
