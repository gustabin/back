package ar.com.santanderrio.obp.config.proxy;
...
public class ProxyServlet extends HttpServlet {
     ...
     */
    private static final String P_CONNECTIONREQUESTTIMEOUT = "http.connectionrequest.timeout";

    /**
     * A integer parameter name to set max connection number
     */
    private static final String P_MAXCONNECTIONS = "http.maxConnections";
    ...
    private static final String ATTR_TARGET_URI = ProxyServlet.class.getSimpleName() + ".targetUri";
    private static final String ATTR_TARGET_HOST = ProxyServlet.class.getSimpleName() + ".targetHost";
    ...
    private void copyProxyCookie(HttpServletRequest servletRequest,
        ...
        for (HttpCookie cookie : HttpCookie.parse(headerValue)) {
            ...
            servletCookie.setHttpOnly(isHttpOnlyDomain(proxyCookieName));
            servletResponse.addCookie(servletCookie);
        }
    }

    private boolean isHttpOnlyDomain(String cookieName) {
        ArrayList<String> httpOnlyDomains = new ArrayList<String>() {{
            add("dtCookie");
            add("__Secure-SSID");
            add("__Secure-HSID");
            add("__Secure-3PSIDCC");
            add("__Secure-3PSID");
            add("TS0153582a");
            add("TS012b2b03");
            add("TOKENSC");
        ...
        return httpOnlyDomains.contains(cookieName);
    }
