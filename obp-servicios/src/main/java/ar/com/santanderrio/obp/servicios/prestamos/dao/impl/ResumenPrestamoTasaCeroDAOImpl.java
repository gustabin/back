...
import ar.com.santanderrio.obp.servicios.prestamos.dao.ResumenPrestamoTasaCeroDAO;

/**
 * The Class ResumenesCuentaDAOImpl.
 */
@Component
public class ResumenPrestamoTasaCeroDAOImpl implements ResumenPrestamoTasaCeroDAO {

	/** The Constant LOGGER. */
	private static final Logger LOGGER = LoggerFactory.getLogger(ResumenPrestamoTasaCeroDAOImpl.class);
