 ...
 */
@Record
public class ResultadoMerlinEntity {
	 ...
	 */
    public boolean esCodigoOk() {
        return "00000000".equals(codigoRetornoExtendido);
    }
    
    /**
	 * Es codigo warning por cambio domicilio.
	 *
	 * @return true, if successful
	 */
    public boolean esCodigoWarningPorCambioDomicilio() {
        return "20000004".equals(codigoRetornoExtendido);
    }
}
