...
/**
 * The Class DetalleRentabilidadTotalEntity.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class DetalleRentabilidadTotalEntity {
	...
	/** The datos. */
	@JsonProperty("Datos")
	private DatosRespuestaRentabilidadTotal datos;
	 ...
	 * @return the datos
	 */
	public DatosRespuestaRentabilidadTotal getDatos() {
		return datos;
	}
	 ...
	 *            the new datos
	 */
	public void setDatos(DatosRespuestaRentabilidadTotal datos) {
		this.datos = datos;
	}
