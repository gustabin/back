...
/**
 * The Class DatosGraficoRentabilidadEntity.
 */
public class DatosGraficoRentabilidadEntity {
	...
	private List<GraficoRentabilidadRespuesta> resultado;
	 ...
	 */
	public List<GraficoRentabilidadRespuesta> getResultado() {
		return resultado;
	}
	 ...
	 *            the new resultado
	 */
	public void setResultado(List<GraficoRentabilidadRespuesta> resultado) {
