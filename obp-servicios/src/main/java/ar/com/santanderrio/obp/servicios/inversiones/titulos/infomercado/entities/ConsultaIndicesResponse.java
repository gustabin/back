...
/**
 * The Class ConsultaIndicesResponse.
 */
...
public class ConsultaIndicesResponse {
	...
	/** The datos. */
	@JsonProperty("Datos")
	private DatosConsultaIndicesResponse datos;
	 ...
	 * @return the datos
	 */
	public DatosConsultaIndicesResponse getDatos() {
		return datos;
	}
	 ...
	 *            the datos to set
	 */
	public void setDatos(DatosConsultaIndicesResponse datos) {
		this.datos = datos;
	}
