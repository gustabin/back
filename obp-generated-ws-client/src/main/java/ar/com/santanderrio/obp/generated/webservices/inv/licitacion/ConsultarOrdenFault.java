...
/**
 * This class was generated by Apache CXF 3.0.0 2017-09-13T13:02:25.530-03:00
...
public class ConsultarOrdenFault extends Exception {
    /** The Serial Version UID. */
    private static final long serialVersionUID = -5552418168368288405L;
    private ar.com.santanderrio.obp.generated.webservices.inv.licitacion.LicitacionesServiceFault licitacionesServiceFault;

    public ConsultarOrdenFault() {
        super();
    }

    public ConsultarOrdenFault(String message) {
        super(message);
    }

    public ConsultarOrdenFault(String message, Throwable cause) {
        super(message, cause);
    }
