 ...
 * 2021-07-08T10:42:25.490-03:00
 * Generated source version: 2.7.6
 * 
 */
@WebServiceClient(name = "ServicesService", 
                  wsdlLocation = "http://wasinethomomya01.ar.bsch:9080/servicios/Services/wsdl/Services.wsdl",
...
public class ServicesService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://wasinethomomya01.ar.bsch:9080/servicios/Services/wsdl/Services.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ServicesService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://wasinethomomya01.ar.bsch:9080/servicios/Services/wsdl/Services.wsdl");
        }
        WSDL_LOCATION = url;
    }
