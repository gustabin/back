...
import ar.com.santanderrio.obp.generated.webservices.discador.Trx168TransferenciaAch;


/**
 * <p>Java class for TDatosClienteHeadRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TDatosClienteHeadRequest">
 *   &lt;complexContent>
...
@XmlType(name = "TDatosClienteHeadRequest", propOrder = {
    "fechaNacimiento",
    "idCliente",
    "indSinonimo",
    "pinCliente",
...
@XmlSeeAlso({
    TDatosClienteRequest.class,
    Trx168TransferenciaAch.class
})
public class TDatosClienteHeadRequest
    extends MappingModelBase
{
    ...
    @XmlElementRef(name = "IndSinonimo", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Common.Request", type = JAXBElement.class)
    protected JAXBElement<String> indSinonimo;
    @XmlElementRef(name = "PinCliente", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Common.Request", type = JAXBElement.class)
    protected JAXBElement<String> pinCliente;
    @XmlElementRef(name = "TipoId", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Common.Request", type = JAXBElement.class)
    protected JAXBElement<String> tipoId;
    @XmlElementRef(name = "TipoPersona", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Common.Request", type = JAXBElement.class)
