...
@XmlRootElement(name = "ObtenerSaldoCuentasCustodia")
public class ObtenerSaldoCuentasCustodia {

    @XmlElementRef(name = "input", namespace = "http://tempuri.org/", type = JAXBElement.class)
