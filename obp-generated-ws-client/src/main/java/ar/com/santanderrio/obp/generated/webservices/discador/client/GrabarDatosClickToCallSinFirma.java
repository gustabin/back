...
@XmlRootElement(name = "GrabarDatosClickToCall_SinFirma")
public class GrabarDatosClickToCallSinFirma {

    @XmlElementRef(name = "json", namespace = "http://tempuri.org/", type = JAXBElement.class)
