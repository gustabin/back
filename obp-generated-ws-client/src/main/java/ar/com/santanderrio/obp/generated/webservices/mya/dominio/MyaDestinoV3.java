...
public class MyaDestinoV3 {
    ...
    @XmlElement(name = "DestinoAlta")
    private String destinoAlta;
    @XmlElement(name = "DestinoModificado")
    private String destinoModificado;
    @XmlElement(name = "DestinoCanal")
    private String destinoCanal;
    @XmlElement(name = "DestinoSubCanal")
    private String destinoSubCanal;
	...
	public String getDestinoAlta() {
		return destinoAlta;
	}

	public void setDestinoAlta(String destinoAlta) {
	...
	public void setDestinoModificado(String destinoModificado) {
		this.destinoModificado = destinoModificado;
	}

	public String getDestinoCanal() {
		return destinoCanal;
	}

	public void setDestinoCanal(String destinoCanal) {
		this.destinoCanal = destinoCanal;
	}

	public String getDestinoSubCanal() {
		return destinoSubCanal;
	}

	public void setDestinoSubCanal(String destinoSubCanal) {
		this.destinoSubCanal = destinoSubCanal;
	}
    ...
    public int hashCode() {
        ...
        hcb.append(estado);
        hcb.append(destinoAlta);
        hcb.append(destinoModificado);
        hcb.append(destinoCanal);
        hcb.append(destinoSubCanal);
    ...
    public boolean equals(Object obj) {
        ...
        MyaDestinoV3 other = (MyaDestinoV3) obj;
        ...
        eb.append(destinoAlta, other.getDestinoAlta());
        eb.append(destinoModificado, other.getDestinoModificado());
        eb.append(destinoCanal, other.getDestinoCanal());
        eb.append(destinoSubCanal, other.getDestinoSubCanal());
        return eb.isEquals();
    }
	...
	public String toString() {
		return new ToStringBuilder(this).append(id).append(tipo).append(codigoOperacion).append(secuencia)
				.append(descripcion).append(empresaCel).append(estado).append(destinoAlta).append(destinoModificado)
				.append(destinoCanal).append(destinoSubCanal).toString();
	}
