...
/**
 * <p>Java class for Trx201IdentificacionDeLlamadaRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Trx201IdentificacionDeLlamadaRequest">
 *   &lt;complexContent>
...
@XmlType(name = "Trx201IdentificacionDeLlamadaRequest", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx201", propOrder = {
    "idIvr",
    "idPort",
    "idUsuario",
    "pwdRacf",
...
public class Trx201IdentificacionDeLlamadaRequest
    extends RequestBase
{
    ...
    @XmlElementRef(name = "IdUsuario", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx201", type = JAXBElement.class)
    protected JAXBElement<String> idUsuario;
    @XmlElementRef(name = "PwdRacf", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx201", type = JAXBElement.class)
    protected JAXBElement<String> pwdRacf;
    @XmlElement(name = "SessionID")
    protected Integer sessionID;
    @XmlElementRef(name = "TipoBanca", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx201", type = JAXBElement.class)
    protected JAXBElement<String> tipoBanca;
    @XmlElementRef(name = "UsrRacf", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx201", type = JAXBElement.class)
