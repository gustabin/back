...
/**
 * This class was generated by Apache CXF 3.0.0 2017-09-13T13:02:25.482-03:00
...
public class ReversarOrdenFault extends Exception {
    /**
     * The Serial Version UID.
     */
    private static final long serialVersionUID = -7153152358817177449L;
    private ar.com.santanderrio.obp.generated.webservices.inv.licitacion.LicitacionesServiceFault licitacionesServiceFault;

    public ReversarOrdenFault() {
        super();
    }

    public ReversarOrdenFault(String message) {
        super(message);
    }

    public ReversarOrdenFault(String message, Throwable cause) {
        super(message, cause);
    }
