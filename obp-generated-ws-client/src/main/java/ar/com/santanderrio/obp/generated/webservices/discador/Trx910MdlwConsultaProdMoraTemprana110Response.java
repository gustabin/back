...
/**
 * <p>Java class for Trx910MdlwConsultaProdMoraTemprana110Response complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Trx910MdlwConsultaProdMoraTemprana110Response">
 *   &lt;complexContent>
...
@XmlType(name = "Trx910MdlwConsultaProdMoraTemprana110Response", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx910", propOrder = {
    "cant",
    "estado",
    "fecMaxProm",
    "productos"
})
public class Trx910MdlwConsultaProdMoraTemprana110Response
    extends TrxHeaderResponseBase
{

    @XmlElementRef(name = "Cant", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx910", type = JAXBElement.class)
    protected JAXBElement<String> cant;
    @XmlElementRef(name = "Estado", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx910", type = JAXBElement.class)
    protected JAXBElement<String> estado;
    @XmlElementRef(name = "FecMaxProm", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx910", type = JAXBElement.class)
    protected JAXBElement<String> fecMaxProm;
    @XmlElementRef(name = "Productos", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx910", type = JAXBElement.class)
