...
/**
 * <p>Java class for GetClientSegmentSelectLaborableDataResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetClientSegmentSelectLaborableDataResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="DiaLaborable" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "GetClientSegmentSelectLaborableDataResponse", namespace = "http://schemas.datacontract.org/2004/07/BSR.CRMBE.API.Services.DataContracts.ClientData", propOrder = {
    "celularEjecutivo",
    "cuadrante",
    "diaLaborable",
    "ejecutivo",
...
public class GetClientSegmentSelectLaborableDataResponse {

    @XmlElementRef(name = "CelularEjecutivo", namespace = "http://schemas.datacontract.org/2004/07/BSR.CRMBE.API.Services.DataContracts.ClientData", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "DiaLaborable", namespace = "http://schemas.datacontract.org/2004/07/BSR.CRMBE.API.Services.DataContracts.ClientData", type = JAXBElement.class)
    protected JAXBElement<String> diaLaborable;
    ...
    @XmlElementRef(name = "ExecutiveAttentionSchedule", namespace = "http://schemas.datacontract.org/2004/07/BSR.CRMBE.API.Services.DataContracts.ClientData", type = JAXBElement.class)
    protected JAXBElement<String> executiveAttentionSchedule;
    @XmlElementRef(name = "ExecutiveLoan", namespace = "http://schemas.datacontract.org/2004/07/BSR.CRMBE.API.Services.DataContracts.ClientData", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "MailEjecutivo", namespace = "http://schemas.datacontract.org/2004/07/BSR.CRMBE.API.Services.DataContracts.ClientData", type = JAXBElement.class)
    protected JAXBElement<String> mailEjecutivo;
    @XmlElementRef(name = "MarcaSelectOnline", namespace = "http://schemas.datacontract.org/2004/07/BSR.CRMBE.API.Services.DataContracts.ClientData", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "Picture", namespace = "http://schemas.datacontract.org/2004/07/BSR.CRMBE.API.Services.DataContracts.ClientData", type = JAXBElement.class)
    protected JAXBElement<byte[]> picture;
    @XmlElementRef(name = "SelectOnlineAttentionSchedule", namespace = "http://schemas.datacontract.org/2004/07/BSR.CRMBE.API.Services.DataContracts.ClientData", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "TelefonoMasivo", namespace = "http://schemas.datacontract.org/2004/07/BSR.CRMBE.API.Services.DataContracts.ClientData", type = JAXBElement.class)
    ...
    /**
     * Gets the value of the diaLaborable property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getDiaLaborable() {
        return diaLaborable;
    }

    /**
     * Sets the value of the diaLaborable property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setDiaLaborable(JAXBElement<String> value) {
        this.diaLaborable = value;
    }
