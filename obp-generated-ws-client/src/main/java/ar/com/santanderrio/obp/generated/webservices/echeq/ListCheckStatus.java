...
/**
 * <p>Java class for ListCheckStatus complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListCheckStatus">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="intcheque_ids" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "ListCheckStatus", propOrder = {
    "intchequeIds",
    "cuit",
    "trkCnl",
    "trkScnl",
...
public class ListCheckStatus {

    @XmlElement(name = "intcheque_ids", nillable = true)
    protected List<String> intchequeIds;
    ...
    /**
     * Gets the value of the intchequeIds property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the intchequeIds property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getIntchequeIds().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getIntchequeIds() {
        if (intchequeIds == null) {
            intchequeIds = new ArrayList<String>();
        }
        return this.intchequeIds;
    }
