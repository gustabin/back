...
/**
 * <p>Java class for Trx739MdlwAutorizBancoVendeMonedaExtranjeraResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Trx739MdlwAutorizBancoVendeMonedaExtranjeraResponse">
 *   &lt;complexContent>
...
@XmlType(name = "Trx739MdlwAutorizBancoVendeMonedaExtranjeraResponse", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx739", propOrder = {
    "niocuentas",
    "numbole",
    "numiden",
    "porimpu",
...
public class Trx739MdlwAutorizBancoVendeMonedaExtranjeraResponse
    extends TrxMonedaResponseBase
{
    ...
    @XmlElementRef(name = "NUMBOLE", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx739", type = JAXBElement.class)
    protected JAXBElement<String> numbole;
    @XmlElementRef(name = "NUMIDEN", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx739", type = JAXBElement.class)
    protected JAXBElement<String> numiden;
    @XmlElementRef(name = "PORIMPU", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx739", type = JAXBElement.class)
    protected JAXBElement<String> porimpu;
    @XmlElementRef(name = "TIPOID", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx739", type = JAXBElement.class)
    protected JAXBElement<String> tipoid;
    @XmlElementRef(name = "TOTCARG", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx739", type = JAXBElement.class)
