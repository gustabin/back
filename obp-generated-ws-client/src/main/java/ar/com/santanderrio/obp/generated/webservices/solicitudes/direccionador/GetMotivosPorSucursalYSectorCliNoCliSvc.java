...
@XmlRootElement(name = "GetMotivosPorSucursalYSectorCliNoCliSvc")
public class GetMotivosPorSucursalYSectorCliNoCliSvc {

    @XmlElementRef(name = "valor", namespace = "http://tempuri.org/", type = JAXBElement.class)
