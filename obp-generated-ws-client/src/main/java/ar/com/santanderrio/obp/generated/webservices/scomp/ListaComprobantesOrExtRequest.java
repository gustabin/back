...
public class ListaComprobantesOrExtRequest {
    ...
    /** The filtros. */
    @XmlElement(required = true)
    protected FiltroListaComprobantesOrExt filtros;
     ...
     * @return the filtros
     */
    public FiltroListaComprobantesOrExt getFiltros() {
        return filtros;
    }
     ...
     *            the filtros to set
     */
    public void setFiltros(FiltroListaComprobantesOrExt filtros) {
