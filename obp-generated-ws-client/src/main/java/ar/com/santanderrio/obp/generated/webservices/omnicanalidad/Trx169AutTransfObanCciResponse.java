...
/**
 * <p>Java class for Trx169AutTransfObanCciResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Trx169AutTransfObanCciResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="NumeroSecuencia" type="{http://www.w3.org/2001/XMLSchema}double" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "Trx169AutTransfObanCciResponse", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx169", propOrder = {
    "codigoEstado",
    "fechaCompensacion",
    "importeDebitado",
    "indBD",
...
public class Trx169AutTransfObanCciResponse
    extends TrxHeaderResponseBase
{

    @XmlElementRef(name = "CodigoEstado", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx169", type = JAXBElement.class)
    protected JAXBElement<String> codigoEstado;
    @XmlElementRef(name = "FechaCompensacion", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx169", type = JAXBElement.class)
    protected JAXBElement<String> fechaCompensacion;
    @XmlElementRef(name = "ImporteDebitado", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx169", type = JAXBElement.class)
    protected JAXBElement<String> importeDebitado;
    @XmlElementRef(name = "IndBD", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx169", type = JAXBElement.class)
    protected JAXBElement<String> indBD;
    @XmlElementRef(name = "NumeroComprobante", namespace = "http://schemas.datacontract.org/2004/07/ISBAN.SrvTran.Common.DataContratcs.Trx169", type = JAXBElement.class)
    protected JAXBElement<String> numeroComprobante;
    @XmlElement(name = "NumeroSecuencia")
    protected Double numeroSecuencia;
     ...
     *     
     */
    public Double getNumeroSecuencia() {
     ...
     *     
     */
    public void setNumeroSecuencia(Double value) {
