...
@XmlRootElement(name = "WM_SALDOS_OBCM_X_FECHA_XLS")
public class WMSALDOSOBCMXFECHAXLS {
    ...
    @XmlElementRef(name = "cno", namespace = "http://tempuri.org/", type = JAXBElement.class)
