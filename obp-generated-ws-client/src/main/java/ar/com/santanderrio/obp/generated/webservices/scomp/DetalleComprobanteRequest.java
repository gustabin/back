...
/**
 * Request para detalle de comprobante.
 * 
 *
 */
...
public class DetalleComprobanteRequest {
    ...
    /** The filtros. */
    @XmlElement(required = true)
    protected FiltroDetalleComprobante filtros;
    ...
    public FiltroDetalleComprobante getFiltros() {
		return filtros;
	}

	public void setFiltros(FiltroDetalleComprobante filtros) {
